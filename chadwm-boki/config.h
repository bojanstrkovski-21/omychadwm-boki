...
static const char *fonts[]          = {"MesloLGS Nerd Font Propo:style:bold:size=11","JetBrainsMono Nerd Font Mono:style:medium:size=11" };
...
static const char* power[] = { "bash", "-c","~/.config/powermenu/powermenu.sh", NULL };

/* launchers BEFORE tags */
static const Launcher launchers_left[] = {
    /* command       name to display */
    { eww,           "" },
};

/* launchers AFTER layout symbol */
static const Launcher launchers_right[] = {
    /* command       name to display */
    { firefox,       "" },
    { kitty,         "󰄛" },
    { thunar,        "󱂶" },
...
/* launchers BEFORE systray (after status text) */
static const Launcher launchers_systray[] = {
    /* command       name to display */    { power,         "⏻" },
};
